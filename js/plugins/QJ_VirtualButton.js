...
/*:
 * @target MV MZ
 * @plugindesc 虚拟按键插件[MV/MZ通用][1.1.8]
 * @author Qiu Jiu
...
Game_VB_Base.prototype.initBaseSaveData = function() {
    ...
    if (!VBDataDetail) {
        VBDataDetail = ConfigManager.VBData[this._buttonId] = {
            opacity:Math.judgeAndOutAttribute(this._setting.opacityDefault,230),
...
Game_VB_Base.prototype.updateShowOrHide = function() {
    ...
    else if (!this.isTextHideVisible(vs))          {result = true;}
