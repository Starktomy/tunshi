 ...
 *   (v1.8)MOG_BattlerMotion  敌人 - 技能动作 + 敌人呼吸效果
 *   (v1.3)MOG_HPGauge        敌人 - 生命浮动框
 *
 * -----------------------------------------------------------------------------
 * ----激活条件
...
WaveNumber.prototype.createLayout = function() {
     this._layout = new Sprite(ImageManager.loadSystem(Moghunter.src_consBat_waveA));
...
WaveNumber.prototype.createTurnLayout = function() {
    this._layoutTurn = new Sprite(ImageManager.loadSystem(Moghunter.src_consBat_waveB ));
