 ...
 *   这将针对一个盟友，然后添加所有活着的友方成员。
 *
 *   <Target: Target x Random Allies> 随机队友
 *   这将以一个盟友为目标，然后随机增加x个活着的盟友。
 *
 *   <Target: x Random Allies> 随机角色
 *   这会随机增加x个活着的联盟成员。
 *
 *   <Target: Everybody param Multiple Of x> 符合特定状态的角色
 *   将“param”替换为“level”、“maxhp”、“maxmp”、“atk”、“def”、
 *   “mat”、“mdf”、“agi”、“luk”、“hp”、“mp”或“tp”。
 *   这将使技能或物品不分青红皂白地瞄准战场上参数值为x的倍数的
 *   任何活着的战士。
 *   *注意：如果您使用的是'level'，请确保您有YEP\u EnemyLevels.js。
 *
 *   <Target: Allies param Multiple Of x> 符合特定状态的队友
 *   将“param”替换为“level”、“maxhp”、“maxmp”、“atk”、“def”、
 *   “mat”、“mdf”、“agi”、“luk”、“hp”、“mp”或“tp”。
 *   这将使技能或物品的目标是战场上任何活着的盟军成员，其参数值是x的倍数。
 *   *注意：如果您使用的是'level'，请确保您有YEP\u EnemyLevels.js。
 *
 *   <Target: Foes param Multiple Of x> 符合特定状态的敌方
 *   将“param”替换为“level”、“maxhp”、“maxmp”、“atk”、“def”、
 *   “mat”、“mdf”、“agi”、“luk”、“hp”、“mp”或“tp”。
 *   这将使技能或物品瞄准战场上参数值为x的倍数的任何活着的敌方战士。
 *   *注意：如果您使用的是'level'，请确保您有YEP\u EnemyLevels.js。
 *
 *   --- 需要YEP\u RowFormation.js和YEP\u BattleEngineCore.js ---
 *
