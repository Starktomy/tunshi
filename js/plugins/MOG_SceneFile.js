...
/*:
 * @plugindesc (v1.0)[v1.5]  主菜单 - 全自定义存档界面
...
//  以下为MOG可视化编辑器生成部分
//=============================================================================
	Moghunter.using_selfDesignCode_save = String(Moghunter.parameters["是否使用可视化代码"] || "true") == "true";
	if(Moghunter.using_selfDesignCode_save){	    Moghunter.scFile_MaxData = 8;
	    Moghunter.scFile_NoData = "- 没有存档 -";
	    Moghunter.scFile_HelpX = 20;
	    Moghunter.scFile_HelpY = 520;

	    Moghunter.scFile_SnapX = 318;
	    Moghunter.scFile_SnapY = 186;
	    Moghunter.scFile_Snap_slideX = 100;
	    Moghunter.scFile_Snap_slideY = 0;
	    Moghunter.scFile_Snap_slideTime = 20;
	    Moghunter.scFile_Snap_width = 340;
	    Moghunter.scFile_Snap_height = 198;

	    Moghunter.scFile_SelX = 723;
	    Moghunter.scFile_SelY = 121;
	    Moghunter.scFile_Sel_width = 351;
	    Moghunter.scFile_Sel_height = 466;
	    Moghunter.scFile_Sel_FontSize = 22;
	    Moghunter.scFile_Sel_col = 2;
	    Moghunter.scFile_Sel_itemHeight = 100;
	    Moghunter.scFile_Sel_change = false;
	    Moghunter.scFile_CursorX = -9;
	    Moghunter.scFile_CursorY = 2;

	    Moghunter.scFile_ActX = 258;
	    Moghunter.scFile_ActY = 122;
	    Moghunter.scFile_Act_slideX = -100;
	    Moghunter.scFile_Act_slideY = 0;
	    Moghunter.scFile_Act_slideTime = 25;
	    Moghunter.scFile_ParBack_visible = true;
	    Moghunter.scFile_ParBackX = 0;
	    Moghunter.scFile_ParBackY = 0;
	    Moghunter.scFile_Act_width = 465;
	    Moghunter.scFile_Act_height = 580;
	    Moghunter.scFile_FontSize = 22;
	    Moghunter.scFile_Text_visible = true;
	    Moghunter.scFile_TextColor = 23;
	    Moghunter.scFile_PlayTimeWord = "";
	    Moghunter.scFile_PlayTimeX = 99;
	    Moghunter.scFile_PlayTimeY = -3;
	    Moghunter.scFile_LocationWord = "所在地";
	    Moghunter.scFile_LocationX = 88;
	    Moghunter.scFile_LocationY = 290;
	    Moghunter.scFile_nameX = 216;
	    Moghunter.scFile_nameY = 360;
	    Moghunter.scFile_levelX = 88;
	    Moghunter.scFile_levelY = 361;
	    Moghunter.scFile_goldX = 0;
	    Moghunter.scFile_goldY = 250;
	    Moghunter.scFile_ParX = -288;
	    Moghunter.scFile_ParY = 309;
	    Moghunter.scFile_ParS_hor = 150;
	    Moghunter.scFile_ParS = 28;
	    Moghunter.scFile_Par_hpmp_visible = false;
	    Moghunter.scFile_ActorX = 142;
	    Moghunter.scFile_ActorY = 212;
	    Moghunter.scFile_Actor_slideX = 0;
	    Moghunter.scFile_Actor_slideY = 0;
	    Moghunter.scFile_Actor_slideTime = 35;
...
//=============================================================================
	Moghunter.menu_save_act_list_length = 60;
	Moghunter.menu_save_act_list = {};
	Moghunter.menu_save_act_list[1] = 'cundang-001';
	Moghunter.menu_save_act_list[2] = 'cundang-002';
	Moghunter.menu_save_act_list[2] = 'cundang-003';
	Moghunter.menu_save_act_list[2] = 'cundang-004';
	Moghunter.menu_save_act_list[2] = 'cundang-013';
	};	
//=============================================================================
// ** ImageManager
//=============================================================================
