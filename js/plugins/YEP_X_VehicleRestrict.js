 ...
 * @param Boat Restrict
 * @parent ---小型船---
 * @desc このリージョンIDは、小型船が入るのを制限します。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Boat Allow
 * @parent ---小型船---
 * @desc このリージョンIDは常に小型船の通過を許可します。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Boat Land
 * @parent ---小型船---
 * @desc このリージョンIDは、小型船が着陸できる場所です。0にすると全てのリージョンに着陸できます。
 * @default 0
 *
 * @param ---大型船---
 * @default
 ...
 * @param Ship Restrict
 * @parent ---大型船---
 * @desc このリージョンIDは大型船の入港を制限します。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Ship Allow
 * @parent ---大型船---
 * @desc このリージョンIDは常に大型船の通過を許可します。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Ship Land
 * @parent ---大型船---
 * @desc このリージョンIDは、大型船が着陸できる場所です。0にすると全てのリージョンに着陸できます。
 * @default 0
 *
 * @param ---飛行船---
 * @default
 ...
 * @param Airship Restrict
 * @parent ---飛行船---
 * @desc このリージョンIDは飛行船の進入を制限します。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Airship Allow
 * @parent ---飛行船---
 * @desc このリージョンIDは常に飛行船を通過させます。複数のリージョンを使用するには、スペースで区切ります。
 * @default 0
 *
 * @param Airship Land
 * @parent ---飛行船---
 * @desc このリージョンIDは飛行船が着陸できる場所です。0にすると全てのリージョンに着陸できます。
 * @default 0
 *
 * @help
 * 翻訳:ムノクラ
