...
/*:
 * @plugindesc (v1.1)[v1.2]  主菜单 - 全自定义技能界面
 ...
 * =============================================================================
 * 可完全自己定义的技能界面设置。
 * 配置有六个部分，技能类型、技能窗口、角色框、角色面板、选择框、杂项数据。
 * 【现已支持插件关联资源的打包、加密】
 *
 * -----------------------------------------------------------------------------
 * ----关联文件
 * 先确保项目img文件夹下是否有menus_skill文件夹！      (img/menus_skill)
 * 先确保项目img文件夹下是否有menus_actorwindow文件夹!(img/menus_actorwindow)
 * 如果没有，需要自己建立。需要配置资源文件：
 *
 * 资源-整体布局      (menus_skill文件夹)
 * 资源-技能窗口      (menus_skill文件夹)
 * 资源-类型窗口      (menus_skill文件夹)
 * 资源-角色框        (menus_skill文件夹)
 * 资源-角色框生命条  (menus_skill文件夹)
 * 资源-角色框魔法条  (menus_skill文件夹)
 *
 * 框头像-1 （menus_skill文件夹，头像1与编号为1的角色对应。）
 * 框头像-2
 * 框头像-3
 * ………
 * 
 * 资源-角色面板      (menus_actorwindow文件夹)
...
　　var Moghunter = Moghunter || {}; 
    ...
    Moghunter.using_selfDesignCode_skill = String(Moghunter.parameters["是否使用可视化代码"] || "true") == "true";
	if(Moghunter.using_selfDesignCode_skill){	
//=============================================================================
//  以下为MOG可视化编辑器生成部分
//=============================================================================
	    Moghunter.scSkill_HelpWindowX = 491 ;
	    Moghunter.scSkill_HelpWindowY = 499 ;
	    Moghunter.scSkill_ItemWindowX = -336 ;
	    Moghunter.scSkill_ItemWindowY = 224 ;
	    Moghunter.scSkill_ItemWindow_L_slideX = 0 ;
	    Moghunter.scSkill_ItemWindow_L_slideY = 0 ;
	    Moghunter.scSkill_ItemWindow_R_slideX = 60 ;
	    Moghunter.scSkill_ItemWindow_R_slideY = 0 ;
	    Moghunter.scSkill_ItemWindow_slideTime = 20 ;
	    Moghunter.scSkill_Wlayout_visible =  true ;
	    Moghunter.scSkill_WlayoutX = 0 ;
	    Moghunter.scSkill_WlayoutY = 0 ;
	    Moghunter.scSkill_ItemWindowWidth = 345 ;
	    Moghunter.scSkill_ItemWindowHeight = 370 ;
	    Moghunter.scSkill_ItemWindow_fontsize = 22 ;
	    Moghunter.scSkill_ItemWindow_col = 1 ;
	    Moghunter.scSkill_TypeWindow_visible = true ;
	    Moghunter.scSkill_TypeWindowX = 519 ;
	    Moghunter.scSkill_TypeWindowY = 217 ;
	    Moghunter.scSkill_TypeWindow_slideX = 0 ;
	    Moghunter.scSkill_TypeWindow_slideY = 0 ;
	    Moghunter.scSkill_TypeWindow_slideTime = 20 ;
	    Moghunter.scSkill_Tlayout_visible = true ;
	    Moghunter.scSkill_TlayoutX =  -1 ;
	    Moghunter.scSkill_TlayoutY =  12 ;
	    Moghunter.scSkill_TypeWindowWidth = 153 ;
	    Moghunter.scSkill_TypeWindowHeight = 201 ;
	    Moghunter.scSkill_TypeWindow_fontsize = 22 ;
	    Moghunter.scSkill_TypeWindow_col = 1 ;
	    Moghunter.scSkill_AS_X = 132 ;
	    Moghunter.scSkill_AS_Y = 133 ;
	    Moghunter.scSkill_AS_FaceX = -20 ;
	    Moghunter.scSkill_AS_FaceY = -19 ;
	    Moghunter.scSkill_AS_hp_X = 258 ;
	    Moghunter.scSkill_AS_hp_Y =  33 ;
	    Moghunter.scSkill_AS_mp_X = 258 ;
	    Moghunter.scSkill_AS_mp_Y = 57 ;
	    Moghunter.scSkill_AS_name_X = 84 ;
	    Moghunter.scSkill_AS_name_Y = 9 ;
	    Moghunter.scSkill_AS_ParFontSize = 22 ;
	    Moghunter.scSkill_AS_MeterHPX = 78 ;
	    Moghunter.scSkill_AS_MeterHPY = 43 ;
	    Moghunter.scSkill_AS_MeterMPX = 64 ;
	    Moghunter.scSkill_AS_MeterMPY = 60 ;
	    Moghunter.scSkill_AS_StatesX = 235 ;
	    Moghunter.scSkill_AS_StatesY = 1 ;
	    Moghunter.scSkill_ActorWinX = 866 ;
	    Moghunter.scSkill_ActorWinY = 125 ;
	    Moghunter.scSkill_ActorWin_sildeX = 100 ;
	    Moghunter.scSkill_ActorWin_sildeY = 0 ;
	    Moghunter.scSkill_ActorWin_sildeTime = 20 ;
	    Moghunter.scSkill_ActorWinlayout_X = 0 ;
	    Moghunter.scSkill_ActorWinlayout_Y = 0 ;
	    Moghunter.scSkill_ActorParFontSize = 22 ;
	    Moghunter.scSkill_ActorFaceX = 26 ;
	    Moghunter.scSkill_ActorFaceY =28 ;
	    Moghunter.scSkill_ActorStatesX = 170 ;
	    Moghunter.scSkill_ActorStatesY = -190 ;
	    Moghunter.scSkill_ActorParX = -5 ;
	    Moghunter.scSkill_ActorParY = 165 ;
	    Moghunter.scSkill_ActorPar_hor = 80 ;
	    Moghunter.scSkill_ActorPar_ver = 33 ;
	    Moghunter.scSkill_Actor_NameX = 92 ;
	    Moghunter.scSkill_Actor_NameY = -194 ;
	    Moghunter.scSkill_PartyX = 656 ;
	    Moghunter.scSkill_PartyY = 295 ;
	    Moghunter.scSkill_PartyX_hide = -303 ;
	    Moghunter.scSkill_PartyY_hide = 306 ;
	    Moghunter.scSkill_PartyX_last = 529 ;
	    Moghunter.scSkill_PartyY_last = 195 ;
	    Moghunter.scSkill_PartyX_next = 529 ;
	    Moghunter.scSkill_PartyY_next = 395 ;
	    Moghunter.scSkill_PartyFontSize = 22 ;
	    Moghunter.scSkill_PartyNameX = 11 ;
	    Moghunter.scSkill_PartyNameY = 50 ;
	    Moghunter.scSkill_PartyHPNumberX = 21 ;
	    Moghunter.scSkill_PartyHPNumberY = 3 ;
	    Moghunter.scSkill_PartyMPNumberX = 118 ;
	    Moghunter.scSkill_PartyMPNumberY = 3 ;
	    Moghunter.scSkill_PartyHPMeterX = 10 ;
	    Moghunter.scSkill_PartyHPMeterY = 36 ;
	    Moghunter.scSkill_PartyMPMeterX = 122 ;
	    Moghunter.scSkill_PartyMPMeterY = 36 ;
	    Moghunter.scSkill_PartyStatusX = 169 ;
	    Moghunter.scSkill_PartyStatusY = 48 ;
//=============================================================================
//  角色头像固定位置
//=============================================================================
	Moghunter.menu_Skill_face_list_length = 60;
	Moghunter.menu_Skill_face_list = {};
	Moghunter.menu_Skill_face_list[1] = 'item_lixiaoyu';
	Moghunter.menu_Skill_face_list[2] = 'item_liubei';
	Moghunter.menu_Skill_face_list[3] = 'item_zhangfei';
	Moghunter.menu_Skill_face_list[4] = 'item_guanyu';
	Moghunter.menu_Skill_face_list[6] = 'item_zuoci';
	Moghunter.menu_Skill_face_list[7] = 'item_zhuyan';
	Moghunter.menu_Skill_face_list[8] = 'item_zhangjiao';
	Moghunter.menu_Skill_face_list[13] = 'item_zhangning';

	Moghunter.menu_Skill_as_face_list_length = 60;
	Moghunter.menu_Skill_as_face_list = {};
	Moghunter.menu_Skill_as_face_list[1] = 'LiXiaoYu';
	Moghunter.menu_Skill_as_face_list[2] = 'skill_liubei';
	Moghunter.menu_Skill_as_face_list[3] = 'skill_zhangfei';
	Moghunter.menu_Skill_as_face_list[4] = 'skill_guanyu';
	Moghunter.menu_Skill_as_face_list[6] = 'skill_zuoci';
	Moghunter.menu_Skill_as_face_list[7] = 'skill_zhuyan';
	Moghunter.menu_Skill_as_face_list[8] = 'skill_zhangjiao';
	Moghunter.menu_Skill_as_face_list[13] = 'skill_zhangning';
	Moghunter.menu_Skill_as_face_list[38] = '38zhangbao';
	Moghunter.menu_Skill_as_face_list[39] = '39zhangliang';
	Moghunter.menu_Skill_as_face_list[40] = '40wangzhubu';
	Moghunter.menu_Skill_as_face_list[41] = '41haizeiwang';
	Moghunter.menu_Skill_as_face_list[42] = '42zhangniujiao';
	Moghunter.menu_Skill_as_face_list[43] = '43guanhai';
	Moghunter.menu_Skill_as_face_list[44] = '44heman';
	Moghunter.menu_Skill_as_face_list[45] = '45dengmao';
	Moghunter.menu_Skill_as_face_list[46] = '46chengyuanzhi';
	Moghunter.menu_Skill_as_face_list[47] = '47zhoucang';	}
...
ImageManager.loadMenusskill = function(filename) {
    return this.loadBitmap('img/menus_skill/', filename, 0, true);
};
...
Scene_Skill.prototype.createPartyArrow = function() {
	...
	this._partyArrowAni = [0,0];
	for (var i = 0; i < 2; i++) {
        this._partyArrow[i] = new Sprite(ImageManager.loadMenusActor(Moghunter.src_Skill_select_arrow));
...
Scene_Skill.prototype.createAllMembersScope = function() {
     this._almSprite = new Sprite(ImageManager.loadMenusActor(Moghunter.src_Skill_select_all));
...
PartySkillWindowData.prototype.loadBitmaps = function() {
    this._layImg = ImageManager.loadMenusActor(Moghunter.src_Skill_select_Layout);
	this._hpMeterImg = ImageManager.loadMenusActor(Moghunter.src_Skill_select_hpmeter);
	this._mpMeterImg = ImageManager.loadMenusActor(Moghunter.src_Skill_select_mpmeter);
};
...
ActorSkillDataWindow.prototype.createLayout = function() {
     this._layout = new Sprite(ImageManager.loadMenusActor(Moghunter.src_Skill_actor_Layout));
...
ActorSkillDataWindow.prototype.refreshFaces = function() {
     this._faces.bitmap = ImageManager.loadMenusActor(Moghunter.menu_Skill_face_list[this._actor._actorId])
};
...
ActorStatusSkill.prototype.refreshFace = function() {
     this._face.bitmap = ImageManager.loadMenusskill(Moghunter.menu_Skill_as_face_list[this._actor._actorId]);
};
