...
Yanfly.Param.StatusAttr_mmr = String(Yanfly.Parameters['mmr Name']);
Yanfly.Param.StatusAttr_pcr = String(Yanfly.Parameters['pcr Name']);
...
Window_StatusInfo.prototype.drawAttributeData = function(attr, dx, dy, dw) {
    ...
    switch (attr) {
	case 'mmr':
      this.drawAttributeName(Yanfly.Param.StatusAttr_mmr, dx, dy, dw);
      this.drawAttributeRate(actor.cri + actor.magicalCritRateBonus(), dx, dy, dw);
      break;
	case 'pcr':
      this.drawAttributeName(Yanfly.Param.StatusAttr_pcr, dx, dy, dw);
      this.drawAttributeRate(actor.cri + actor.physicalCritRateBonus(), dx, dy, dw);
      break;
	case 'dcr':
      this.drawAttributeName(Yanfly.Param.StatusAttr_dcr, dx, dy, dw);
      this.drawAttributeRate(2 + actor.criticalMultiplierBonus(), dx, dy, dw);
      break;
    case 'hit':
