...
//=============================================================================
 /*:
 * @plugindesc v1.19 这个信息核心插件为RPG Maker MV的默认信息系统添加了很多功能，
 * 可以使用更多的文本代码，名字框，甚至可以调整文本框大小
 ...
 * @param Default Width
 * @parent ---General---
 * @desc 这是以像素为单位的消息框的默认宽度。
 * Default: Graphics.boxWidth
 * @default Graphics.boxWidth
 *
 * @param Face Indent
 * @parent ---General---
 * @desc 如果使用一个面图形，这是多少文本缩进。
 ...
 * ============================================================================
 *
 * 当RPG Maker MV Ace改善了信息系统以后，我们很伤心的发现只有很少的特点，例如
 * 名字框，文本代码转换为图标或者物品、武器、装备的名字，以及更多流行的地方。这
 * 个脚本可以让开发者自行调整消息框的大小，调整字体或者文本快进的特点
 *
 * ============================================================================
 * 字包装
 * ============================================================================
 *
 * 文本换行功能现在可以通过信息系统来调整。你也可以使用插件命令来开启和关闭这个
 * 换行功能。当开启文本换行的时候，当你的问题超过了文本框的大小，它将会自动转入
 * 下一行。也就是说，文本换行将会关闭编辑器的文本换行功能，并且要求你用下面的代
 * 码来实现。
 *
 * <br> 
 * <line break> 
