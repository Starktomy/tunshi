...
//=============================================================================
 /*:
 * @plugindesc v1.09 一个简单的战斗状态窗口，以水平格式显示角色的面部。
...
Window_BattleStatus.prototype.drawStatusFace = function(index) {
    ...
    var ww = Math.min(rect.width - 120, Window_Base._faceWidth);
    var wh = Math.min(rect.height - 42, Window_Base._faceHeight);
    var wx = rect.x + rect.width - ww - 7;
    var wy = rect.y + 4;
