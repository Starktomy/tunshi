...
/*:
 * @plugindesc v.5.5.6 [MV] Localization of game.
 * @author DKPlugins
 ...
 * @help
 ...
 ###===========================================================================
 Availability of working plugin DKTools version 11.2.4 or above
...
/*:ru
 * @plugindesc v.5.5.6 [MV] Локализация игры.
 * @author DKPlugins
 * @url https://dk-plugins.ru
 * @target MV
 * @base DKTools
 ...
 * @help
 ...
 ###===========================================================================
 Наличие включенного плагина DKTools версии 11.2.4 или выше
...
Imported['DKTools_Localization'] = '5.5.6';

if (Imported['DKTools']) {
    DKTools.PluginManager.requirePlugin('DKTools', '11.2.4');
} else {
