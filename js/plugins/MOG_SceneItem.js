...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneItem');
	...
	Moghunter.scItem_HelpWindowX = Number(Moghunter.parameters['平移-帮助信息 X'] || -100);
	Moghunter.scItem_HelpWindowY = Number(Moghunter.parameters['平移-帮助信息 Y'] || 1000);
	...
	Moghunter.using_selfDesignCode_item = String(Moghunter.parameters["是否使用可视化代码"] || "true") == "true";
	if(Moghunter.using_selfDesignCode_item){
//=============================================================================
//  以下为MOG可视化编辑器生成部分
//=============================================================================
	Moghunter.scItem_ItemWindowWidth =354;
	Moghunter.scItem_ItemWindowHeight =500;
	Moghunter.scItem_ItemWindowX =244;
	Moghunter.scItem_ItemWindowY =126;
	Moghunter.scItem_ItemWindow_L_slideX =-60;
	Moghunter.scItem_ItemWindow_L_slideY =0;
	Moghunter.scItem_ItemWindow_R_slideX =60;
	Moghunter.scItem_ItemWindow_R_slideY =0;
	Moghunter.scItem_ItemWindow_slideTime =15;
	Moghunter.scItem_Wlayout_visible = true;
	Moghunter.scItem_WlayoutX =0;
	Moghunter.scItem_WlayoutY =0;
	Moghunter.scItem_ItemWindow_fontsize =20;
	Moghunter.scItem_ItemWindow_col =1;
	Moghunter.scItem_HelpWindowX =200;
	Moghunter.scItem_HelpWindowY =620;
	Moghunter.scItem_Com1_X =250;
	Moghunter.scItem_Com1_Y =150;
	Moghunter.scItem_Com2_X =370;
	Moghunter.scItem_Com2_Y =150;
	Moghunter.scItem_Com3_X =490;
	Moghunter.scItem_Com3_Y =150;
	Moghunter.scItem_Com4_X =610;
	Moghunter.scItem_Com4_Y =150;
	Moghunter.scItem_ActorWinX =495;
	Moghunter.scItem_ActorWinY =176;
	Moghunter.scItem_ActorWin_sildeX =100;
	Moghunter.scItem_ActorWin_sildeY =0;
	Moghunter.scItem_ActorWin_sildeTime =20;
	Moghunter.scItem_ActorWinlayout_X =0;
	Moghunter.scItem_ActorWinlayout_Y =0;
	Moghunter.scItem_ActorParFontSize =20;
	Moghunter.scItem_ActorFaceX =27;
	Moghunter.scItem_ActorFaceY =28;
	Moghunter.scItem_ActorStatesX =884;
	Moghunter.scItem_ActorStatesY =-228;
	Moghunter.scItem_ActorParX =-5;
	Moghunter.scItem_ActorParY =165;
	Moghunter.scItem_ActorPar_hor =80;
	Moghunter.scItem_ActorPar_ver =33;
	Moghunter.scItem_Actor_NameX =726;
	Moghunter.scItem_Actor_NameY =-240;
	Moghunter.scItem_PartyX =252;
	Moghunter.scItem_PartyY =335;
	Moghunter.scItem_PartyX_hide =-233;
	Moghunter.scItem_PartyY_hide =252;
	Moghunter.scItem_PartyX_last =215;
	Moghunter.scItem_PartyY_last =230;
	Moghunter.scItem_PartyX_next =215;
	Moghunter.scItem_PartyY_next =440;
	Moghunter.scItem_PartyFontSize =20;
	Moghunter.scItem_PartyNameX =10;
	Moghunter.scItem_PartyNameY =46;
	Moghunter.scItem_PartyHPNumberX =11;
	Moghunter.scItem_PartyHPNumberY =8;
	Moghunter.scItem_PartyMPNumberX =120;
	Moghunter.scItem_PartyMPNumberY =8;
	Moghunter.scItem_PartyHPMeterX =10;
	Moghunter.scItem_PartyHPMeterY =36;
	Moghunter.scItem_PartyMPMeterX =123;
	Moghunter.scItem_PartyMPMeterY =36;
	Moghunter.scItem_PartyStatusX =171;
	Moghunter.scItem_PartyStatusY =45;
	Moghunter.menu_item_face_list_length = 60;
	Moghunter.menu_item_face_list = {};
...
//=============================================================================
	Moghunter.menu_item_face_list_length = 60;
	Moghunter.menu_item_face_list = {};
	Moghunter.menu_item_face_list[1] = 'item_lixiaoyu';
	Moghunter.menu_item_face_list[2] = 'item_liubei';
	Moghunter.menu_item_face_list[3] = 'item_zhangfei';
	Moghunter.menu_item_face_list[4] = 'item_guanyu';
	Moghunter.menu_item_face_list[6] = 'item_zuoci';
	Moghunter.menu_item_face_list[7] = 'item_zhuyan';
	Moghunter.menu_item_face_list[8] = 'item_zhangjiao';
	Moghunter.menu_item_face_list[13] = 'item_zhangning';
	Moghunter.menu_item_face_list[38] = 'item_38zhangbao';
	Moghunter.menu_item_face_list[39] = 'item_39zhangliang';
	Moghunter.menu_item_face_list[40] = 'item_40wangzhubu';
	Moghunter.menu_item_face_list[41] = 'item_41haizeiwang';
	Moghunter.menu_item_face_list[42] = 'item_42zhangniujiao';
	Moghunter.menu_item_face_list[43] = 'item_43guanhai';
	Moghunter.menu_item_face_list[44] = 'item_44heman';	
	Moghunter.menu_item_face_list[45] = 'item_45dengmao';		
	Moghunter.menu_item_face_list[46] = 'item_46chengyuanzhi';	}
//=============================================================================
// ** ImageManager
//=============================================================================
