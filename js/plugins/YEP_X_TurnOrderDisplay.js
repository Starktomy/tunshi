 ...
 */
 /*:ja
 * @plugindesc v1.03 (要YEP_BattleEngineCore.jp)ターン制戦闘システムの行動順を表示し、様々な表示オプションを可能にします
 * @author Yanfly Engine Plugins
 *
 * @param ---デフォルト---
 * @default
 ...
 * @type number
 * @min 0
 * @desc 味方に使用されるデフォルトのアイコン。0の場合、アイコンは味方の顔のグラフィックになります。
 * @default 0
 *
 * @param ---敵---
 * @default
 ...
 * @type number
 * @min 0
 * @desc 敵のデフォルトアイコン。0の場合、アイコンは敵の戦闘グラフィックになります。
 * @default 0
 *
 * @param Enemy SV Battlers
 * @parent ---敵---
 ...
 * @on 表示
 * @off 非表示
 * @desc Animated SV Enemiesを使用している場合で、アイコン指定がない場合は戦闘グラフィックを表示しますか？ これは重くなることがあります。 非表示 - false  表示 - true
 * @default false
 *
 * @help
 * 翻訳:ムノクラ
 ...
 * ============================================================================
 *
 * このプラグインは YEP_BattleEngineCore.jp が必要です。
 * プラグイン管理リストでこのプラグインが
 * YEP_BattleEngineCore.jp の下にあることを確認してください。
 *
 * ターン制のバトルシステムでは、プレイヤーにターンの順番を
 * 視覚的に見せることで、戦闘システムに多くの深みを加えることができます。
 * このプラグインは、画面の隅にプレイヤーのパーティーと
 * 敵のパーティーの行動順を示すアイコンの表示を追加します（変更可能）。
 *
 * 注意！ このプラグインはATBやCTBのようなティックベースのバトルシステムでは
 * 動作しません！ 
